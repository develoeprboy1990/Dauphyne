                        ...
                        <div class="input-group mt-3">
                            ...
                            <div class="col-md-10" align="left">
                                <select class="form-control" name="customer" id="sel_customer">
                                    ...
                                    <option value="{{$party->PartyID}},{{$party->PartyName}},'{{$discount}}">{{$party->PartyName}} &nbsp; &nbsp; {{$party->Phone}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row ml-3">
                            ...
                            <div id="customer" class="col-md-12 ml-3">
                                <div class="clientinfo">
                                    ...
                                    <div id="customer_name" align="center">Default: <strong>WalkIn</strong></div>
                                </div>
                            </div>
                        </div>
                        <div id="saman-row-pos" class="rqw mt-3">
                            <div class="col p-mobile">
                                <table id="pos_list" class="table-responsive tfr pos_stripe" style="background-color: #933BB1;">
                                    ...
                                    <tbody id="pos_items" class="text-white"></tbody>
                                </table>
                                <br>
                                <hr>
                                <div class="row mt-3">
                                    <div class="col-3"><input type="hidden" value="1,514.76" id="subttlform" name="subtotal"> <input type="hidden" value="0" id="custom_discount"><strong> Total Tax</strong>
                                    </div>
                                    <div class="col-6"><span class="currenty lightMode">AED</span>
                                        <span id="taxr" class="lightMode">00.00</span>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-6"><input type="text" name="paid_amount" class="form-control" id="paid_amount" onkeyup="showBalance()"></div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-6"><input type="text" name="remaining_bal" value="0.00" class="form-control" id="remaining_bal" readonly></div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="submit" class="save_invoice btn btn-lg btn-success sub-btn">Save</button>
                                    ...
                                    <button type="submit" class="save_print_invoice btn btn-lg btn-success sub-btn">Save & Print</button>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3"><label for="invocieno" class="caption">Invoice Number</label>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Invoice #" name="invocieno" id="invocieno" value="{{$invoice_no}}">
                                            </div>
                                        </div>
        ...
        <div class="modal fade" id="idModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="idModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="text-center">Invoice Created Successfully</p>
                        <p class="text-center">
...
<script type="text/javascript">
    ...
    $('.save_invoice').on('click', function(e) {
        ...
        $.ajax({
            url: "{{url('save-pos-invoice')}}",
            dataType: 'JSON',
            method: 'POST',
            data: $(data_form).serialize(),
            beforeSend: function() {
                $(".save_invoice").attr('disable', true);
                $('#idModal').modal('show', {
                    backdrop: 'static'
                });
            },
            success: function(data) {
                if (data.msg == "success") {
                    $(".save_invoice").attr('disable', false);
    ...
    $('.save_print_invoice').on('click', function(e) {
        e.preventDefault();
        let data_form = document.getElementById("data_form");
        let fd = new FormData(data_form);
        var data = {};
        ...
        $.ajax({
            ...
            data: $(data_form).serialize(),
            beforeSend: function() {
                $(".save_print_invoice").attr('disable', true);
                $('#idModal').modal('show', {
                    backdrop: 'static'
                });
            },
            success: function(data) {
                if (data.msg == "success") {
                    $(".save_print_invoice").attr('disable', false);
