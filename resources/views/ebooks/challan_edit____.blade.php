...
@foreach ($challan_detail as $key => $value1)
 <?php $no= $key+1; ?>
  ...
  <td>
                <input type="text" name="Qty[]" id="Qty_{{$no}}" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Qty}}">
              </td>
                
              <td>
                <input type="text" name="Price[]" id="Price_{{$no}}" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Rate}}" >
              </td>
             ...
             <tr class="p-3">
                      ...
                      <td>
                        ...
                        <input type="textfield" name="ItemName[]" id="ItemName_{{$no}}" class=" form-control" value="{{$value1->IteName}}">
                      </td>
                ...
                <input type="text" name="Qty[]" id="Qty_{{$no}}" class=" form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Qty}}">
                      ...
                      <td>
                        <input type="textfield" name="Unit[]" id="Unit_{{$no}}" class=" form-control  "  >
                      </td>
                   
                      <td>
                        <input type="text" name="Remarks[]" id="Remarks_{{$no}}" class=" form-control "  >
                      </td>
                    </tr>
...
<!-- end of for each -->
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-12 mt-3 "><h6>Customer Notes: </h6>
             ...
             <h6 class="pt-3">Description Notes: </h6>


                <textarea class="form-control" rows='5' name="DescriptionNotes" id="note" placeholder="Description Notes"></textarea>
 ...
 var i = $('table tr').length;
  $(".addmore").on('click', function() {
    ...
    html += '<td class="p-1"><input class="case" type="checkbox"/></td>';
     html += '<td><input type="text" name="ItemName[]" id="ItemTotal_' + i + '" class="form-control totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
