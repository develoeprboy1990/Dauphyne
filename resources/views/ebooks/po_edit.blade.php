                    ...
                    <select name="UserID" id="UserID" class="form-select">
                      ...
                      <?php endforeach ?>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="first-name" class="form-control" name="Subject" placeholder="Let your customer know what this invoice is for" value="{{$purchaseorder_master[0]->Subject}}">
                      ...
                      <input type="text" id="first-name" class="form-control" name="PurchaseOrderNo" value="{{ $purchaseorder_master[0]->PON}}">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker21">
                                                <input type="text" name="Date" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="{{$purchaseorder_master[0]->Date}}">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group" id="datepicker22">
                                                <input type="text" name="DueDate" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker22" data-provide="datepicker" data-date-autoclose="true" value="{{$purchaseorder_master[0]->DeliveryDate}}">
                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ReferenceNo" autocomplete="off" class="form-control" value="{{$purchaseorder_master[0]->ReferenceNo}}">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8 col-12  ">
                                ...
                                <textarea class="form-control" rows='5' name="CustomerNotes" id="note" placeholder="">{{$purchaseorder_master[0]->PONotes}}</textarea>

                                <label for="" class="mt-2">Description</label>
                                <textarea class="form-control" rows='5' name="DescriptionNotes" id="note" placeholder="Description notes if any.">{{$purchaseorder_master[0]->DeliveryNotes}}</textarea>
                                ...
                                <div class="mt-2"><button type="submit" class="btn btn-success w-md float-right">Save</button>
                                    <a href="{{URL('/PurchaseOrder')}}" class="btn btn-secondary w-md float-right">Cancel</a>
                                ...
                                <form class="form-inline">
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="grandtotaltax" name="grandtotaltax" placeholder="Subtotal" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$purchaseorder_master[0]->Tax}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Grandtotal" class="form-control" step="0.01" id="grandtotal" placeholder="Grand Total" readonly onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$purchaseorder_master[0]->GrandTotal}}">
                                        </div>
                                    </div>
