 ...
 <input type="text"  class="form-control" name="WalkinCustomerName" value="" placeholder="Walkin cusomter" id="1WalkinCustomerName" >
                            ...
                            <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="first-name" class="form-control" name="EstimateNo" value="{{$estimate_master[0]->EstimateNo}}" disabled="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8 col-12  ">
                                ...
                                <textarea class="form-control" rows='2' name="CustomerNotes" id="notes" placeholder="Enter any notes to be displayed in your transaction">{{$estimate_master[0]->CustomerNotes}}</textarea>
                            ...
                            <div class="col-lg-4 col-12 ">
                                ...
                                <form class="form-inline">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Total" class="form-control" step="0.01" id="totalafterdisc" readonly placeholder="Total" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"  value="{{$estimate_master[0]->Total}}">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1">
                                        <label>Tax: &nbsp;</label>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Grandtotal" class="form-control" step="0.01" id="grandtotal" placeholder="Grand Total" readonly onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"  value="{{$estimate_master[0]->Total}}">
                                        </div>
                                    </div>
