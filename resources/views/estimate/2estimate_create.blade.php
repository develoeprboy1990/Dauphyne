...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <!-- start page title -->
            <h4 class="m-2">Create Estimate</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="col-12">
                                    <div class="mb-1 row">
                                        <div class="col-sm-3">
                                            <label class="col-form-label text-danger" for="first-name">Delivery Challan #</label>
                                        </div>
                                        <div class="col-sm-9">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr class="p-3">
                                            ...
                                            <td>
                                                <input type="number" name="TaxAmount[]" id="TaxAmount_1" class=" form-control  " autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01">
                                            </td>
                                            <td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-12 mt-3 ">
                                ...
                                <textarea class="form-control" rows='2' name="CustomerNotes" id="notes" placeholder="Enter any notes to be displayed in your transaction"></textarea>
                                ...
                                <form class="form-inline">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="Tax" class="form-control" step="0.01" id="totalTax" placeholder="Tax %" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="mt-2"><button type="submit" class="btn btn-success w-lg float-right">Save</button>
                                <a href="{{URL('/DeliveryChallan')}}" class="btn btn-secondary w-lg float-right">Cancel</a>
