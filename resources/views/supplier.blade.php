                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="mb-2 row">
                      ...
                      <div class="col-md-8">
                        <input class="form-control" type="text" value="{{old('TRN')}}" name="TRN">
                      </div>
                    </div>
                    <div class="mb-2 row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="mb-2 row">
                      <label for="example-url-input" class="col-md-3 col-form-label fw-bold">Invoice Due Days</label>
                      <div class="col-md-8">
                        <input class="form-control" type="number" name="InvoiceDueDays" value="{{old('InvoiceDueDays')}}">
                      </div>
                    </div>
                    <div class="mb-2 row">
                      <label for="example-tel-input" class="col-md-3 col-form-label fw-bold">Active</label>
                      <div class="col-md-8">
