...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{URL('/DebitNoteSave')}}" method="post">
                ...
                <div class="mb-1 row">
                            ...
                            <div class="col-12">
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="InvoiceNo" autocomplete="off" class="form-control" value="DN-{{$vhno[0]->VHNO}}">
...
<iframe src="{{URL('/Attachment')}}" width="100%" height="40%" border="0" scrolling="yes" style="overflow: hidden;"></iframe>
                                ...
                                <div class="mt-2"><button type="submit" class="btn btn-success w-md float-right">Save</button>
                                    <a href="{{URL('/DebitNote')}}" class="btn btn-secondary w-md float-right">Cancel</a>
