...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{URL('/DebitNoteUpdate')}}" method="post">
...
<!-- end of for each -->
  ...
  <label for="" class="mt-2">Description</label>
           ...
           <iframe src="{{URL('/Attachment')}}" width="100%" height="40%" border="0" scrolling="yes" style="overflow: 

hidden;"></iframe>                     <div class="mt-2"><button type="submit" class="btn btn-success w-md float-right">Save</button>
                            ...
                            <div class="col-lg-4 col-12 ">
                                ...
                                <form class="form-inline">
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Total" class="form-control" step="0.01" id="totalafterdisc" readonly placeholder="Total" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$invoice_master[0]->Total}}">
                                        </div>
                                    </div>
                                    <div class="form-group mt-1">
                                        <label>Tax: &nbsp;</label>
                                    ...
                                    <div class="form-group mt-1">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-light">{{session::get('Currency')}}</span>
                                            <input type="number" name="Grandtotal" class="form-control" step="0.01" id="grandtotal" placeholder="Grand Total" readonly onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="{{$invoice_master[0]->GrandTotal}}">
                                        </div>
                                    </div>
